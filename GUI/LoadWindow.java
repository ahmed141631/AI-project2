...
public class LoadWindow extends JFrame {
    ...
    public static int player = constants.player_1;
        ...
        public void actionPerformed(ActionEvent ev) {
            if (ev.getSource() == cancel) {
                ...
                try {
                    ...
                    player = (player == 0) ? constants.player_1 : constants.player_2;


                    if (GUI.board.getGameBoard()[row][column] == constants.Empty_pos) {
                    ...
                    Board.print(GUI.board.getGameBoard());
